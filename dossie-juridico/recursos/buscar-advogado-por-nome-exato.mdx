---
title: Buscar Advogado por Nome ou Razão Social Exato
description: "Consulte todos os processos judiciais relacionados a um advogado, com base no nome exato."
---

# 🔎 Buscar por Nome ou Razão Social Exato (Advogado)

Este endpoint permite consultar todos os processos em que um determinado nome exato esteja envolvido como advogado **ativo**, **passivo** ou **outros**.
...
```
POST https://api.predictus.inf.br/predictus-api/processos/judiciais/buscarPorNomeExatoAdvogado
```
