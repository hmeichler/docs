...
Retorna uma lista de objetos do tipo [`processo`](../estrutura-dados) com os campos padrão da Predictus, acrescidos dos campos solicitados em `camposRetorno.incluir`.
