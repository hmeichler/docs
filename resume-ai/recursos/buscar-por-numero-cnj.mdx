...
| `grauProcesso` | Sim | integer | Grau do processo: `1` (1º grau), `2` (2º grau), `3` (instância especial), `4` (instância extraordinária) |
| `dataDistribuicao` | Sim | string | Data de distribuição do processo no formato `YYYY-MM-DD` |
| `sistema` | Não | string | Sistema de origem do processo (ex: `PJE-TRT2`, `ESAJ`, `PROJUDI`) — auxilia na localização dos documentos |
...
- `grauProcesso`: não nulo, valor entre `1` e `4`
- `dataDistribuicao`: não nulo, formato `YYYY-MM-DD`
