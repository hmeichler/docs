---
title: Sumário Advogado por CPF
description: "Visualize estatísticas agregadas dos processos relacionados a um CPF."
---

# 📊 Sumário Jurídico por CPF (Advogado)

Este endpoint retorna uma visão **agregada** dos processos judiciais em que o CPF informado esteja envolvido, como advogado **ativo**, **passivo** ou **outros**.
...
```
POST https://api.predictus.com.br/predictus-api/processos/judiciais/sumarioPorCPFAdvogado
```
