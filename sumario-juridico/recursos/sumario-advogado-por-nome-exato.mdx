---
title: Sumário Advogado por Nome Exato
description: "Visualize estatísticas agregadas dos processos relacionados a um Nome Exato."
---

# 📊 Sumário Jurídico por Nome Exato (Advogado)

Este endpoint retorna uma visão **agregada** dos processos judiciais em que um nome exato informado esteja envolvido, como advogado **ativo**, **passivo** ou **outros**.
...
```
POST https://api.predictus.com.br/predictus-api/processos/judiciais/sumarioPorNomeExatoAdvogado
```
