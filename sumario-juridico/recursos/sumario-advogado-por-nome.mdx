---
title: Sumário Advogado por Nome
description: "Visualize estatísticas agregadas dos processos relacionados a um Nome."
---

# 📊 Sumário Jurídico por Nome (Advogado)

Este endpoint retorna uma visão **agregada** dos processos judiciais em que um nome informado esteja envolvido, como advogado **ativo**, **passivo** ou **outros**.
...
```
POST https://api.predictus.com.br/predictus-api/processos/judiciais/sumarioPorNomeAdvogado
```
