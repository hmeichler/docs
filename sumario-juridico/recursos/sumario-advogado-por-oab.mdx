---
title: Sumário Advogado por OAB
description: "Visualize estatísticas agregadas dos processos relacionados a uma OAB."
---

# 📊 Sumário Jurídico por OAB (Advogado)

Este endpoint retorna uma visão **agregada** dos processos judiciais em que a OAB informada esteja envolvida, como advogado **ativo**, **passivo** ou **outros**.
...
```
POST https://api.predictus.com.br/predictus-api/processos/judiciais/sumarioPorOAB
```
