...
Você pode aplicar os mesmos filtros utilizados na consulta do Dossiê Jurídico por CPF.
...
- Demais campos seguem as mesmas regras de [Buscar por CPF](./buscar-parte-por-cpf)
